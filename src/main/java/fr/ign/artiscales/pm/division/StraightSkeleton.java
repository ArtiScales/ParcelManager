...
public class StraightSkeleton {
  ...
  public StraightSkeleton(Polygon p, double[] angles, double cap) {
    ...
    try {
      ...
      TopologicalGraph.setSRID(p.getSRID());
    } catch (Exception e) {
...
//  }
    ...
    TopologicalGraph.export(graph.getFaces(), new File(folderOut,"faces.gpkg"), Polygon.class);
   TopologicalGraph.export(graph.getEdges(), new File(folderOut,"edges.gpkg"), LineString.class);
  }
}
